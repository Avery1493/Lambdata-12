...
def splitdate(df, column):
    ...
    Param column is a column header surrounded in quotes
...
def temp_conv(degrees,metric=True):
    """
    Param "degrees" is the temperature as integer or float  
    Param "metric" is the unit degrees is measured in  
